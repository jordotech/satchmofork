...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('product_optiongroup', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'OptionGroup.description'
        db.alter_column('product_optiongroup', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
