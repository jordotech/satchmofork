...
class Product(models.Model):
    ...
    upc = models.CharField(verbose_name=_('UPC'), max_length=12, null=True, blank=True, help_text=_("12 digit EAN UPC"), unique=True,)
    ...
    rush = models.BooleanField(_("Rush"), default=False)
