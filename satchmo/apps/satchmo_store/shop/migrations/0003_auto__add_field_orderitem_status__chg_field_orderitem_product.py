...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_orderitem', 'status',
                      self.gf('model_utils.fields.StatusField')(default='cutting', max_length=100, no_check_for_status=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('shop_orderitem', 'status')
    ...
    models = {
        ...
        'shop.orderitem': {
            ...
            'quantity': ('django.db.models.fields.DecimalField', [], {'max_digits': '18', 'decimal_places': '6'}),
            'status': ('model_utils.fields.StatusField', [], {'default': "'cutting'", 'max_length': '100', u'no_check_for_status': 'True'}),
