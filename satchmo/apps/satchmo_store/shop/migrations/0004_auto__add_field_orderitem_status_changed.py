...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderItem.status_changed'
        db.add_column('shop_orderitem', 'status_changed',
                      self.gf('model_utils.fields.MonitorField')(default=datetime.datetime.now, monitor='status'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderItem.status_changed'
        db.delete_column('shop_orderitem', 'status_changed')
