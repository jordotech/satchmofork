...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderItem.notes'
        db.add_column('shop_orderitem', 'notes',
                      self.gf('django.db.models.fields.TextField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderItem.notes'
        db.delete_column('shop_orderitem', 'notes')
    ...
    models = {
        ...
        'product.product': {
            ...
            'upc': ('django.db.models.fields.CharField', [], {'max_length': '12', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'shop.orderitem': {
            ...
            'quantity': ('django.db.models.fields.DecimalField', [], {'max_digits': '18', 'decimal_places': '6'}),
            'status': ('model_utils.fields.StatusField', [], {'default': "'none'", 'max_length': '100', u'no_check_for_status': 'True'}),
